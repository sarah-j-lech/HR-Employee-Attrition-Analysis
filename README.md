...
* **High Risk Roles:** Sales Representatives and Lab Technicians have the highest turnover rates.
* **Demographics:** "Young Adults" (<30) are the most likely age group to leave.

## Tools Used
* **SQL (SQLite):** For data aggregation and salary analysis.
* **Tableau Public:** For interactive dashboarding.
* **Excel:** For initial data cleaning and feature engineering.
